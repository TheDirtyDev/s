...
export default function MapPage() {
  ...
  const topPoster = Object.entries(counts).sort((a: any, b: any) => (b[1] as number) - (a[1] as number))[0] || ["N/A", 0];
  ...
  return (
    <main className="min-h-screen bg-black text-white p-4 md:p-12 selection:bg-zinc-800">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        {/* Sidebar - Optimized for mobile width */}
        ...
        {/* Intelligence Center - Responsive Height */}
        <motion.div 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        {/* Protocol Footer - Stacked properly on mobile */}
        <div className="lg:col-start-2 lg:col-span-3 border border-zinc-800 bg-zinc-900/20 p-5 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-1">
            <h2 className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold">// FIELD PROTOCOL</h2>
            <p className="text-[10px] text-zinc-400 font-mono">Verify coordinates. Maintain stealth.</p>
          </div>
          <div className="flex gap-8 justify-between md:justify-end">
            <div>
              <div className="text-[9px] text-zinc-600 uppercase">Compliance</div>
              <div className="text-[10px] font-mono">LEVEL 04</div>
            </div>
            <div>
              <div className="text-[9px] text-zinc-600 uppercase">Encryption</div>
              <div className="text-[10px] font-mono">AES-256</div>
            </div>
          </div>
        </div>
      </div>
